...
globalThis.SwaggerProtoBufUIBundle = (
	...
	if (!globalThis.SwaggerUIBundle) {
		const swaggerUIElement =
			document.getElementById("swagger-ui") || document.createElement("div");
		...
		errorElement.setAttribute(
			"style",
			"position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);font-size:40px;width:100%;text-align:center;"
		);

		errorElement.innerText =
			"SwaggerUiBundle not found\nPlease import swagger-ui-bundle.js";
